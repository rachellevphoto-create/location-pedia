...
export default function RootNotFound() {
  ...
  return (
    <div
      dir="rtl"
      className="flex min-h-[80vh] items-center justify-center bg-gradient-to-b from-slate-50 to-white px-4 py-16"
    >
      <div className="mx-auto flex w-full max-w-md flex-col items-center text-center">
        ...
        <p className="mt-4 text-base text-muted-foreground">{t.notFoundBody}</p>
